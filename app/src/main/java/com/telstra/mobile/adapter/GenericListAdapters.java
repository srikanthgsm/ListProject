package com.telstra.mobile.adapter;
...
public class GenericListAdapters extends BaseAdapter {

    LayoutInflater inflater;
    Activity context;
    ArrayList<JSONResponseModel.InfoListItem> listItem;
    public GenericListAdapters(Activity context, ArrayList<JSONResponseModel.InfoListItem> itemList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        UrlImageViewHelper.setUrlDrawable(holder.imageView,
                listItem.get(position).imageHref, R.color.list_item_heading_txt_color,
